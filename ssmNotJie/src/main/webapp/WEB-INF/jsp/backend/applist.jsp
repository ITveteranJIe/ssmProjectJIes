...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					手游 审核列表 <i class="fa fa-user"></i><small>${userSession.userName}
						- 您可以通过搜索或者其他的筛选项对手游的信息进行审核操作。^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/manager/backend/app/list">
					<input type="hidden" name="pageIndex" value="1" />
			    <ul>
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">手游名称</label>
								...
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<button type="button" class="btn btn-default checkApp" 
											...
											data-toggle="tooltip" data-placement="top" title="" data-original-title="查看并审核手游P">审核</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
