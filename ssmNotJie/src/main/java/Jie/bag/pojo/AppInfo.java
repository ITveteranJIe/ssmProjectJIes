...
public class AppInfo {
	...
	//展示属性 vo
	private String statusName;//app状态名称    status
	private String flatformName;//app所属平台名称  flatformId
	private String categoryLevel3Name;//所属三级分类名称  categoryLevel3
	private String devName;//开发者名称  devId
	
	private Integer categoryLevel1;//所属一级分类id
	private Integer categoryLevel2;//所属二级分类id

	//展示属性vo
	private String categoryLevel1Name;//所属一级分类名称 categoryLevel1
	private String categoryLevel2Name;//所属二级分类名称 categoryLevel2
